...
3. 갈등 가능성을 설명할 때도 그것이 관계의 끝을 의미하지 않는다는 점을 함께 전하고, 실제로 참고할 수 있는 구체적인 조언을 1~2가지 포함하세요.
4. 사주는 자기이해와 재미를 위한 콘텐츠라는 성격을 유지하고, 의학적·법률적·금융적 사실처럼 단정하지 마세요.
5. 주어진 데이터에 없는 사실(직업, 실제 이름, 실제 사건 등)을 지어내지 마세요.
6. 결과는 2~3개 문단, 총 300자 내외의 자연스러운 한국어 존댓말로 작성하세요. 소제목이나 목록 기호 없이 문단으로만 답하세요.`;
